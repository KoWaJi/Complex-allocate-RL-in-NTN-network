...
import numpy as np
from csv_to_result import CsvToResultHandler

n_ue = 15
n_step = 100
n_episode = 200
path = os.path.dirname(os.path.realpath(__file__))
path_data = r"/home/cuichuankai/code_from_pycharm/GCN-DL/training data"
# path_data = os.path.join(path, 'tb_data')
dirs = next(os.walk(path_data))  # [1]用于通过在目录树中游走输出在目录中的文件名，向上或者向下。
